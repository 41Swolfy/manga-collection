...
function buildbody() {
  ...
  MainAreamangacontainervolumes.setAttribute(
    "class",
    "manga_volume_size2 manga_volumes2"
  );
...
async function apiCall(edition, index = 1) {
  ...
  const mangaResponse = await fetch(
    `https://api.manga-passion.de/editions/${edition}`,
    { method: "GET" }
  );
...
async function getdata() {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    if (Mangadate < currentDate && Mangadate >= past67Days) {
      ...
      imageInner.style.cssText =
        "box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 142% 0px 0px;";
        ...
        case Band:
          switch (data[i].title) {
            case "Angels of Death":
              imageElement.src = ` /websites/Covers/Angels_of_Death${
                Band - 1
              }.webp`;
              anchor.setAttribute("href", "/websites/Angels_of_Death.html");
              break;
            case "Shangri-La Frontier":
              imageElement.src = ` /websites/Covers/shangri_la_frontier${
                Band - 1
              }.webp`;
              anchor.setAttribute("href", "/websites/Shangri_La_Frontier.html");
              break;
            case "Bakemonogatari":
              imageElement.src = `/websites/Covers/bakemonogatari${
                Band - 1
              }.webp`;
            ...
            case "Can't Stop Cursing You":
              imageElement.src = `/websites/Covers/cant_stop_cursing_you${
                Band - 1
              }.webp`;
              anchor.setAttribute(
                "href",
                "/websites/Cant_stop_cursing_you.html"
              );
              break;
            case "Call of the Night":
              imageElement.src = `/websites/Covers/Yofukashi_no_Uta${
                Band - 1
              }.webp`;
              anchor.setAttribute("href", "/websites/Yofukashi_no_Uta.html");
              break;
            case "Chainsaw Man":
              imageElement.src = `/websites/Covers/Chainsaw_man${
                Band - 1
              }.webp`;
            ...
            case "Demon Slayer – Kimetsu no Yaiba":
              imageElement.src = `/websites/Covers/Demon_Slayer${
                Band - 1
              }.webp`;
            ...
            case "My Elder Sister":
              imageElement.src = `/websites/Covers/elder_sister${
                Band - 1
              }.webp`;
              anchor.setAttribute("href", "/websites/Elder_Sister.html");
              break;
            case "Neon Genesis Evangelion - Perfect Edition":
              imageElement.src = `/websites/Covers/evangelion_perfect${
                Band - 1
              }.webp`;
            ...
            case "Fullmetal Alchemist Ultra":
              imageElement.src = `/websites/Covers/fullmetal_alchemist${
                Band - 1
              }.webp`;
              anchor.setAttribute(
                "href",
                "/websites/Fullmetal_Alchemist_Ultra.html"
              );
              break;
            ...
            case "MoMo – the blood taker –":
              imageElement.src = `/websites/Covers/Momo_the_bloodtaker${
                Band - 1
              }.webp`;
            ...
            case "More than a Doll":
              imageElement.src = `/websites/Covers/sono_bisque_doll_wa_koi_wo_suru${
                Band - 1
              }.webp`;
              anchor.setAttribute(
                "href",
                "/websites/Sono_Bisque_Doll_wa_koi_wo_suru.html"
              );
              break;
            case "Tokyo Revengers: Doppelband-Edition":
              imageElement.src = `/websites/Covers/Tokyo_revengers${
                Band - 1
              }.webp`;
              anchor.setAttribute("href", "/websites/Tokyo_revengers.html");
              break;
            case "Bungo Stray Dogs: BEAST":
              imageElement.src = `/websites/Covers/Bungo_Stray_dogs_beast${
                Band - 1
              }.webp`;
              anchor.setAttribute(
                "href",
                "/websites/Bungo_Stray_Dogs_BEAST.html"
              );
              switch (Band) {
                case 2:
                  Band = "3 & 4";
      ...
      const mangaVolumesDiv = document.querySelector(
        ".manga_volume_size2.manga_volumes2"
      );
      ...
      if (statustext == 2) {
        ...
        document.getElementById(
          "pricemanga" + [i]
        ).textContent = `Band ${Band} · ${priceInEuro}  €`; // had problem with data displaying year  2099 if its neither released or announced
        document.getElementById("datemanga" + [i]).textContent = `TBA`;
      } else {
        document.getElementById(
          "pricemanga" + [i]
        ).textContent = `Band ${Band} · ${priceInEuro}  €`;
        document.getElementById(
          "datemanga" + [i]
        ).textContent = `${formattedDate}`;
      }
...
function sum() {
  ...
  const urls = [
    ...
    "/Dropped/D_rt.html",
    "/Dropped/D_uz.html",
  ]; //path to all Manga to get the count
  ...
  Promise.all(urls.map((url) => fetch(url).then((response) => response.text())))
    .then((htmls) => {
      ...
      document.getElementById("manga_title2").innerHTML =
        "Anzahl an gesammelten Manga: " +
        sum +
        "  | " +
        "Geschätzte Ausgaben : " +
        (8.463172849 * sum).toFixed(2) +
        "€ | Ausgaben Zeitraum : " +
        (pricesum / 100).toFixed(2); // 8.463172849 is the fixed avg spent per manga /updating it sometimes /
    })
